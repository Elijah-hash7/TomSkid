...
export function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-1/2 z-50 w-full -translate-x-1/2 border-t border-border/80 bg-card/95 px-2 pb-[max(0.5rem,env(safe-area-inset-bottom))] pt-2 backdrop-blur-md md:bottom-6 md:max-w-[430px] md:rounded-b-[2rem] md:border md:border-border/70 md:border-t"
      aria-label="Primary"
    >
